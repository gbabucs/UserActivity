...
class Request: NSObject {
    ...
    init(apiURL: ApiRequestURL , requestType: ApiRequestType = .GET ) {
        self.endpoint = apiURL.value
        self.requestMethod = requestType
    }
    
    func performNetworkOperationWithData(completion: @escaping (_ isSuccess: Bool ,_ responseData: Data? ,_ error: Error?) -> Void) {
